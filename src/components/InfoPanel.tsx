...
const TASKS = [
  ...
  {
    title: '④ 拆开亮线上的一个点',
    do: '打开右侧「亮线分析」开关，拖动亮线上的点。',
    see: '每个点都射出一把半光锥，无论点拖到哪里，锥面始终恰好扫过你的眼睛；射向眼睛的那条反射光就是锥面上的一根母线。',
    why: '亮线条件 (p̂−q̂)·t̂ = 0 说的就是"指向眼睛的方向 q̂ 与入射方向 p̂ 对沟槽轴 t̂ 的张角相同"——q̂ 天然躺在以 t̂ 为轴的锥面上。亮线上的每个点，都是这把锥与眼睛"对准"的位置。',
  },
  {
    title: '⑤ 把亮线"推"出板面',
